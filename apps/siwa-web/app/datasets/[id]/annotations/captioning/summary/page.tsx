/**
 * Captioning annotation summary page, mirroring classification summary layout.
 */
"use client";
...
export default function CaptioningSummaryPage() {
    ...
    (async () => {
      try {
        const [dsRes, summaryRes] = await Promise.all([
          ...
          api.get(`/datasets/${datasetId}/annotations/captioning/summary`),
        ]);
        setDs(dsRes.data);
    ...
    <div className="space-y-4">
      <div className="bg-white border rounded-2xl p-5 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2 text-xs text-blue-600 mt-4">
          ...
          {canAnnotate && (
            <Link
              href={`/datasets/${datasetId}/annotate/captioning`}
              className="underline"
            >
              Open Annotator
            </Link>
