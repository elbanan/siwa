/**
 * Classification annotation summary page.
 * Provides a quick snapshot of dataset progress via the API summary endpoint.
 */
"use client";
    ...
    (async () => {
      try {
        const [dsRes, summaryRes] = await Promise.all([
          ...
          api.get(`/datasets/${datasetId}/annotations/classification/summary`),
        ]);
        setDs(dsRes.data);
    ...
    <div className="space-y-4">
      <div className="bg-white border rounded-2xl p-5 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2 text-xs text-blue-600 mt-4">
          ...
          {canAnnotate && (
            <Link
              href={`/datasets/${datasetId}/annotate/classification`}
              className="underline"
            >
              Open Annotator
            </Link>
